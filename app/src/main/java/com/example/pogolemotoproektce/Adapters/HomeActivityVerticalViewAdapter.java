...
public class HomeActivityVerticalViewAdapter extends RecyclerView.Adapter<HomeActivityVerticalViewAdapter.ViewHolder>{

    private Context mContext;
    private ArrayList<Book> books;


    public HomeActivityVerticalViewAdapter(Context context, ArrayList<Book> books) {
        this.books = books;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        Log.i("VerticalViewAdapter", "onCreateViewHolder()");
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        Log.i("VerticalViewAdapter", "onBindViewHolder");
